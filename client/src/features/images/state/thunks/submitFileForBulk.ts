...
const actionType = `${FeatureKeys.Images}/submitFileForBulk`

export const submitFileForBulk = createAsyncThunk<Responses.CreateImage, FormData>(actionType, async (formData: FormData, thunkApi) => {
    try {
