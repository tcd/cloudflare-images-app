 ...
 * ## Note
 *
 * The `onSave` handler also returns `File[]` with all the accepted files.
 */
export class DropzoneDialog extends PureComponent<DropzoneDialogProps, DropzoneDialogState> {
    ...
    public state: DropzoneDialogState = {
        fileObjects: [],
    }
    ...
    deleteFile: DropzoneDialogBaseProps["onDelete"] = (removedFileObj, removedFileObjIdx) => {
